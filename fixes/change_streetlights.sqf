...
_switching = random 85;//Generate random chance for power failures
_switchpercent = 65;//EDITABLE - Percentage for reliability of power supply. eg. 65 will be 65% chance of lights coming on in each house and 35% chance that lights will fail and flicker off.
